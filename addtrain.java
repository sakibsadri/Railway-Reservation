...
public class addtrain extends javax.swing.JFrame {
   ...
   public void Train_Details()
   {
       try
       {
           pat=con.prepareStatement("select *from traindetails");
           rs= pat.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
           pat=con.prepareStatement("insert into traindetails(tno,tname,startplace,destinationplace,price)values(?,?,?,?,?) "); 
           
           pat.setString(1,tno);
            pat.setString(2,trainname);
            pat.setString(3,splace);
             pat.setString(4,dplace);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
           pat=con.prepareStatement("update traindetails set tname=?,startplace=?,destinationplace=?,price=? where tno=? "); 
           
           pat.setString(1,trainname);
            pat.setString(2,splace);
            pat.setString(3,dplace);
             pat.setString(4,price);
              ...
              if(k==1)
              {
                   JOptionPane.showMessageDialog(this, "Record Upd ateded");
              }
              else
              {
                   JOptionPane.showMessageDialog(this, "Record Failed");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
           pat=con.prepareStatement("delete from traindetails where tno=? "); 
